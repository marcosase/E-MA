...
"")
        ...
        self.edtIntegration = PyDMLabel(self.page)
...
"color: rgb(50, 50, 50);")
        self.sbRuns.setMinimum(1)
        self.sbRuns.setMaximum(99999)
...
"    "))
        ...
        self.edtIntegration.setText(_translate("Ui_MainWindow_Ocean", "00.30"))
        self.edtIntegration.setProperty("channel", _translate("Ui_MainWindow_Ocean", "None"))
