...
class Ui_MainWindow_PVnames(object):
    def setupUi(self, MainWindow_PVnames):
        ...
        MainWindow_PVnames.resize(235, 346)
        MainWindow_PVnames.setMinimumSize(QtCore.QSize(235, 346))
        MainWindow_PVnames.setMaximumSize(QtCore.QSize(235, 346))
...
"")
        ...
        self.gridLayout.addWidget(self.buttonBox, 9, 0, 1, 1, QtCore.Qt.AlignRight)
...
"color: rgb(60, 60, 60);")
        ...
        self.gridLayout.addWidget(self.label_motor, 4, 0, 1, 1, QtCore.Qt.AlignHCenter)
        self.label_LS = QtWidgets.QLabel(self.centralwidget)
        self.label_LS.setObjectName("label_LS")
        self.gridLayout.addWidget(self.label_LS, 6, 0, 1, 1, QtCore.Qt.AlignHCenter)
...
"color: rgb(60, 60, 60);")
        ...
        self.gridLayout.addWidget(self.label_spec, 2, 0, 1, 1, QtCore.Qt.AlignHCenter)
